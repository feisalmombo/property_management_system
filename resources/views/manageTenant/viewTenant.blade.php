...
<div class="col-lg-12">
	<h1 class="page-header">All Tenants</h1>
</div>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
                    ...
                    <tbody>
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td>
                                    ...
                                    <div class="modal fade" id="{{ $tenantData->id."show" }}">
				...
				<div class="alert alert-info">
					...
					<strong>No New Tenant found</strong>
				</div>
				@endif
			</div>
			<!-- /.panel-body -->
